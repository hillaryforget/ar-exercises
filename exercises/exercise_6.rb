...
@store1.employees.create(first_name: 'Michael', last_name: 'Scott', hourly_rate: 60)
@store1.employees.create(first_name: 'Jim', last_name: 'Halpert', hourly_rate: 50)

@store2.employees.create(first_name: 'Pam', last_name: 'Beesly', hourly_rate: 50)
@store2.employees.create(first_name: 'Angela', last_name: 'Martin', hourly_rate: 50)
@store2.employees.create(first_name: 'Erin', last_name: 'Hannon', hourly_rate: 50)
